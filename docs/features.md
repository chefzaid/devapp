...
- JaCoCo reports and a 60 percent instruction-coverage gate for service application logic
...
- GitHub Actions reconciliation between GitHub and GitLab without force pushing
